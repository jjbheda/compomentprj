...
import qiyi.bundle.hack.AndroidHack;
import qiyi.bundle.hack.SysHacks;
import qiyi.bundle.log.Logger;
import qiyi.bundle.log.LoggerFactory;
import qiyi.bundle.runtime.BundleInstalledListener;
import qiyi.bundle.runtime.DelegateResources;
import qiyi.bundle.runtime.InstrumentationHook;
import qiyi.bundle.runtime.RuntimeArgs;
...
public class BundleCore {
    ...
    public void init(Application application) throws Exception {
        SysHacks.defineAndVerify();     //全部使用反射，将ActivityThread，Instrument 类hack成自己的
